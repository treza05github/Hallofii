...
## ⚙️ TUGAS PERBAIKAN SISTEM 
List perbaikan website HalloFii deadline tanggal 18 desember 2025:
1. Length untuk login dan registrasi dibatasi. Username (30), email (255) sesuai standar, nomor telpon (15), dan password (255) agar saat password sudah dihash bisa muat. jika karakter melebihi batas akan muncul sweetAlert yang menampilkan error ✅
2. Form login memiliki validasi seperti autentikasi agar email yang digunakan memang benar terdaftar didalam database, jika email tidak ada muncul sweetAlert error✅
3. Tambah akun admin (username: admin2 & pass: 77) dan (username: admin3 & pass: 44) dan sudah dicantumkan kedalam dokumen SRS✅
4. Nomor telpon harus diisi angka dan tidak boleh lebih dari 15 karakter, jika lebih muncul sweetAlert error✅
5. Email harus menggunakan format @gmail.com dan jika tidak pakai muncul sweetAlert error✅
6. Pada (user) fitur pemilihan jadwal tanggal dan waktu reservasi menyesuaikan jam praktek dokter (8.00-17.00) jika pasien memilih jam lebih dari jam ini akan muncul pesan "Klinik tutup" dan juga untuk hari menyesuaikan hari praktek dokter. User tidak bisa sembarang isi lagi✅
7. Pada upload foto dokter dikelola dokter, file yang diupload hanya bisa gambar atau foto✅
8. Fitur pencarian pasien, dokter, dan reservasi di halaman admin maupun pasien berjalan normal tidak mencari hanya berdasarkan username saja✅
