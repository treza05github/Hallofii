...
$filter = ($search != "") ? "WHERE nama_dokter LIKE '%$search%' OR spesialisasi LIKE '%$search%'" : "";

// TOTAL DATA DOKTER
$totalQuery = mysqli_query($koneksi, "
    SELECT COUNT(*) AS total FROM dokter $filter
");
...
<body>
    ...
    <div class="container mt-4">
        ...
        <div class="d-flex align-items-center mb-3">
            <a href="admin.php" class="me-3" style="font-size:24px; text-decoration:none; color:black;">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
                    <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1" />
                </svg>
            </a>
            <h3 class="fw-bold">Data Dokter</h3>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="doktertambah.php" class="btn btn-blue">+ Tambah Dokter</a>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <?php if (!empty($row['foto_dokter'])) { ?>
                                    <img src="data:image/*;base64,<?= base64_encode($row['foto_dokter']); ?>"
                                        class="foto-dokter">
                                <?php } else { ?>
                            ...
                            <td>
                                <a href="dokteredit.php?id=<?= $row['dokter_id'] ?>" ><i class="bi bi-pencil-square edit"></i></a>
